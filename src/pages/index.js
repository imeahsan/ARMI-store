...
import CarLogosCarousel from "@component/carousel/CarLogosCarousel";
                      ...
                      /> */}
                        ...
                        <div class="text-center">
                          ...
                          <button class="mt-4 bg-white text-black py-2 px-4 rounded-full">
                            ...
                            <div
                                className="flex w-full mt-5 max-w-screen-2xl mx-auto flex-col items-center lg:flex-row justify-center">
