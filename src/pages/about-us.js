  ...
  return (
    <Layout title="About Us" description="This is about us page">
      ...
      <div className="bg-white">
        ...
        <div
          className="relative bg-gradient-to-b from-gray-50 to-gray-100 lg:py-20 py-10"
          id="team"
        >
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-32 items-start">
              ...
              <div className="flex justify-center lg:sticky lg:top-24 mb-20">
                <div className="relative group w-full flex flex-col items-center">
                  ...
                  <div className="relative flex justify-center">
                    <div
                      className="rounded-full overflow-hidden bg-white transform group-hover:scale-105 transition-all duration-500 w-64 h-64 sm:w-80 sm:h-80 lg:w-[22rem] lg:h-[22rem]"
                      style={{
                        boxShadow:
                          "0 0 0 8px white, 0 0 0 10px #dc2626,  0 0 0 1px #eab308, 0 25px 50px -12px rgba(0, 0, 0, 0.25)",
                      }}
                    >
                      <Image
                        width={500}
              ...
              <div className=" mt-12 lg:mt-0 space-y-6">
                ...
                <div className="bg-white rounded-2xl p-8 lg:p-10 shadow-lg border-l-4 border-red-600">
                  <svg
                    className="w-10 h-10 text-red-600 opacity-30 mb-4"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
