...
const Footer = () => {
  ...
  return (
    <>
      ...
      <div className="pb-16 lg:pb-0 xl:pb-0 bg-white" id="footer">
        <div className="mx-auto max-w-screen-2xl px-4 sm:px-10">
          <div className="grid grid-cols-2 md:grid-cols-7 xl:grid-cols-12 gap-5 sm:gap-9 lg:gap-11 xl:gap-7 py-10 lg:py-16 spcae-around">
              ...
              <div className="pb-3.5 sm:pb-0 col-span-1 md:col-span-2 lg:col-span-3">
                ...
                <ul className="text-sm lg:text-15px flex flex-col space-y-3">
                  <li
                    ...
                    onClick={userInfo?.email ? () => {} : handleModal}
                  >
                    <Link
                      href={`${
                        userInfo?.email
              ...
              <div className="col-span-1 text-center hidden lg:block md:block">
                {storeCustomizationSetting?.footer?.bottom_contact_status && (
                  <div>
                    ...
                    <h5 className="text-2xl font-bold text-red-500 leading-7">
                      {/* +012345-67900 */}
